...
$all_cate=$add2->getAllCategories();
            ...
            <div class="col-md-4 offset-md-4 form login-form">
                <form method="POST" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="title" placeholder="Name of website">
                        <span class="text-danger"><?php echo $title_error; ?></span>
                    </div>
                    <div class="form-group">
                        <input class="form-control" type="text" name="link" placeholder="Please Enter Valid Link">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        <input class="form-control button" type="submit" name="insert" value="Add Portfolio">
